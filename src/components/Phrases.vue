<template>
  <div>
    <div class="phrase-container">
      ...
      <a v-if="!editMode" @click="editMode = !editMode" class="button is-danger">Edit</a>
      <div class="columns is-mobile" v-if="editMode">
        <div class="column is-half">
          <a @click="editMode = !editMode" class="button is-danger">Cancel</a>
        </div>
        <div class="column is-half">
  ...
  methods: {
    ...
    save() {
      this.delete.map(deleteItem => {
        this.phrases = this.phrases.filter(phrase => phrase.id != deleteItem);
      });
